                ...
                <form action="#" method="GET">
                    <div class="search-wrapper">
                        ...
                        <input type="search" name="cari" class="search-input" id="searchInput"
                            placeholder="Cari tugas berdasarkan judul atau deskripsi..." value="">
            ...
            <div class="tasks-container" id="tasksContainer">
                ...
                <div class="task-card color-1">
                    ...
                    <div class="action-buttons">
                        ...
                        <button type="button" class="btn-action btn-delete"
                            onclick="showDeleteModal(1, 'Lapres', 'Laporan praktikum mingguan untuk mata kuliah Pemrograman Web.', '2025-11-27 07:34')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                viewBox="0 0 16 16">
                                <path
                ...
                <div class="task-card color-2">
                    ...
                    <div class="action-buttons">
                        ...
                        <button type="button" class="btn-action btn-delete"
                            onclick="showDeleteModal(2, 'Tugas Akhir Semester', 'Pengembangan aplikasi web untuk mata kuliah Pemrograman Web Lanjut.', '2025-12-15 23:59')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                viewBox="0 0 16 16">
                                <path
                                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6Z" />
                ...
                <div class="task-card color-3">
                    ...
                    <div class="action-buttons">
                        ...
                        <button type="button" class="btn-action btn-delete"
                            onclick="showDeleteModal(3, 'Presentasi Kelompok', 'Presentasi hasil penelitian tentang teknologi web modern.', '2025-12-05 10:00')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                viewBox="0 0 16 16">
                                <path
                                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6Z" />
                ...
                <div class="task-card color-4">
                    ...
                    <div class="action-buttons">
                        ...
                        <button type="button" class="btn-action btn-delete"
                            onclick="showDeleteModal(4, 'Review Jurnal', 'Review jurnal tentang perkembangan framework JavaScript modern.', '2025-12-20 17:00')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                viewBox="0 0 16 16">
                                <path
                                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6Z" />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-confirm">
                <div class="modal-header modal-header-danger">
                    ...
                    <button type="button" class="btn-close btn-close-white" onclick="closeDeleteModal()"
