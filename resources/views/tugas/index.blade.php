...
@section('content')
        <style>
            ...
            /* Custom scrollbar untuk dropdown (jika browser support) */
            .form-select-styled::-webkit-scrollbar {
                width: 8px;
            }

            .form-select-styled::-webkit-scrollbar-track {
                background: #f1f5f9;
                border-radius: 4px;
            }

            .form-select-styled::-webkit-scrollbar-thumb {
                background: #cbd5e1;
                border-radius: 4px;
            }

            .form-select-styled::-webkit-scrollbar-thumb:hover {
                background: #94a3b8;
            }
                                ...
                                <div class="filter-group">
                                    ...
                                    <div class="select-icon-wrapper">
                                        ...
                                        <select class="form-select form-select-styled" name="sort"
                                            onchange="document.getElementById('searchForm').submit()">
                                            <option value="deadline_asc" {{ request('sort') == 'deadline_asc' ? 'selected' : '' }}>DeadlineTerdekat</option>
                                            <option value="deadline_desc" {{ request('sort') == 'deadline_desc' ? 'selected' : '' }}>DeadlineTerjauh</option>                                            
                                        </select>
                                    </div>
                                </div>
                            </div>                        
