...
<style>
    ...
    /* Dynamic Colors */
    .color-1 { border-color: #3b82f6; background: linear-gradient(to bottom right, #ffffff, #eff6ff); }
    .color-2 { border-color: #10b981; background: linear-gradient(to bottom right, #ffffff, #ecfdf5); }
    .color-3 { border-color: #f59e0b; background: linear-gradient(to bottom right, #ffffff, #fffbeb); }
    .color-4 { border-color: #8b5cf6; background: linear-gradient(to bottom right, #ffffff, #f5f3ff); }
    .color-5 { border-color: #ec4899; background: linear-gradient(to bottom right, #ffffff, #fdf2f8); }
    .color-6 { border-color: #06b6d4; background: linear-gradient(to bottom right, #ffffff, #ecfeff); }
    ...
    .bg-urgent { background: #fef2f2; color: #ef4444; }
    .bg-normal { background: #f0fdf4; color: #15803d; }
    ...
    .btn-edit-task:hover { background: #3b82f6; color: white; }

    .btn-delete-task { background: #fef2f2; color: #ef4444; }
    .btn-delete-task:hover { background: #ef4444; color: white; }
                ...
                <div class="task-card color-{{ $colorIndex }}">
                    ...
                    <div class="task-meta">
                        ...
                        <div class="meta-row mt-2">
                            ...
                            @if($t->file_path)
                                <a href="{{ route('tugas.download', $t->id) }}" class="text-primary text-decoration-none fw-bold">Download File</a>
                            @else
                    ...
                    <div class="task-footer">
                        ...
                        <button type="button" class="btn-icon btn-delete-task" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $t->id }}" title="Hapus">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
