...
@section('content')
    ...
    <style>
        ...
        /* --- 1. ENGINE ANIMASI (Diambil dari Referensi) --- */
        ...
        /* --- 2. TRANSISI HALUS (MAGIC SAUCE) --- */
        /* Ini membuat gerakan hover terasa "mahal" seperti referensi */
        .stat-card,
        .task-card,
        .btn-back,
        .btn-task,
        ...
        /* Hover Stats Card (Efek Baru pada Desain Lama) */
        .stat-card:hover {
        ...
        .task-card {
            ...
            /* Border samping khas desain awal */
            position: relative;
        }
        ...
        /* Hover Task Card (Efek dari Referensi) */
        .task-card:hover {
            transform: translateY(-12px) scale(1.02);
            /* Naik tinggi & Zoom */
            box-shadow: 0 30px 60px rgba(0, 0, 0, 0.12), 0 4px 8px rgba(0, 0, 0, 0.06);
            z-index: 10;
        }
    ...
    <div class="tasks-container">
        <div class="container-fluid">
            ...
            <ul class="nav nav-pills mb-3 fade-in-up" id="pills-tab" role="tablist" style="animation-delay: 0.4s;">
            ...
            <h2 class="section-title fade-in-up" style="margin-top: 2rem; animation-delay: 0.6s;">Tugas Tersedia</h2>

            <div class="available-tasks fade-in-up" style="animation-delay: 0.7s;">
                <div class="available-header">
                    <h3 class="available-title">Tugas Aktif</h3>
